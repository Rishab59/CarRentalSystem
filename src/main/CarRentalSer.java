...
public class CarRentalSer {
    ...
    protected static void addCustomer() {
        ...
        try {
        	System.out.println(repo.addCustomer(customer) ? "Customer added successfully!" : "Error Adding New Customer.");
        } catch (Exception e) {
            System.out.println("Error: " + e.getMessage());
        }
    }
    ...
    protected static void removeCustomer() {
		...
		try {
			if (choice.equals("yes") || choice.equals("y")) {
				System.out.println(repo.removeCustomer(customerID) ? "Customer removed successfully!" : "Error Removing the Customer.");
			} else {
				System.out.print("\n\"Removing Customer\" operation aborted.");
			}
		} catch (Exception e) {
            System.out.println("Error: " + e.getMessage());
        }
